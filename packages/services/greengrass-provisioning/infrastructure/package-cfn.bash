...
DESCRIPTION
    Packages the Greengrass Provisioning service, ready for deployment.
...
logTitle 'Packaging the Greengrass Provisioning CloudFormation template and uploading to S3'
aws cloudformation package \
  --template-file $cwd/cfn-greengrass-provisioning.yml \
  --output-template-file $cwd/build/cfn-greengrass-provisioning-output.yml \
  --s3-bucket $DEPLOY_ARTIFACTS_STORE_BUCKET \
  $AWS_ARGS

logTitle 'Greengrass Provisioning packaging complete!'
