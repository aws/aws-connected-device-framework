...
DESCRIPTION
    Packages the CDF Greengrass deployment service, ready for deployment.
...
logTitle 'Packaging the Greengrass Deployment CloudFormation template and uploading to S3'
aws cloudformation package \
  --template-file $cwd/cfn-greengrass-deployment.yml \
  --output-template-file $cwd/build/cfn-greengrass-deployment-output.yml \
  --s3-bucket $DEPLOY_ARTIFACTS_STORE_BUCKET \
  $AWS_ARGS

logTitle 'Greengrass Deployment packaging complete!'
