...
if [ -z "$AUTH" ]; then
  ...
  template_file='infrastructure/cfn-commands-noAuth.yml'
else
  template_file='infrastructure/cfn-commands.yml' 
fi
...
echo '
**********************************************************
  Packaging the Commands CloudFormation template and uploading to S3
**********************************************************
'

aws cloudformation package \
  --template-file $template_file \
  --output-template-file build/cfn-commands-output.yml \
