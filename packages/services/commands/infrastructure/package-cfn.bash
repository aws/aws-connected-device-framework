...
logTitle 'Packaging the Commands CloudFormation template and uploading to S3'

aws cloudformation package \
  --template-file $cwd/cfn-commands.yml \
  --output-template-file $cwd/build/cfn-commands-output.yml \
  --s3-bucket $DEPLOY_ARTIFACTS_STORE_BUCKET \
  $AWS_ARGS

logTitle 'Commands packaging complete!'