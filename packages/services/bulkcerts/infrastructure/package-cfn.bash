...
DESCRIPTION
    Packages the Bulk Certs service, ready for deployment.
...
if [ "$AUTH" == "true"  ]; then
  template_file='infrastructure/cfn-bulkcerts.yml' 
else 
  echo Warning!  No authorization will be applied.
  template_file='infrastructure/cfn-bulkcerts-noAuth.yml'
fi
...
aws cloudformation package \
  ...
  --output-template-file 'build/cfn-bulkcerts-output.yml' \
