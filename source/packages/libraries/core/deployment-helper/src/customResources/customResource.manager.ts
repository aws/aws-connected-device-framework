...
export class CustomResourceManager {
    ...
    constructor(
        @inject(TYPES.AppConfigOverrideCustomResource)
        protected appConfigOverrideCustomResource: AppConfigOverrideCustomResource,
        @inject(TYPES.AssetLibraryInitCustomResource)
        protected assetLibraryInitCustomResource: AssetLibraryInitCustomResource,
        @inject(TYPES.AssetLibraryBulkGroupsCustomResource)
        protected assetLibraryBulkGroupsCustomResource: AssetLibraryBulkGroupsCustomResource,
        @inject(TYPES.AssetLibraryPolicyCustomResource)
        protected assetLibraryPolicyCustomResource: AssetLibraryPolicyCustomResource,
        @inject(TYPES.AssetLibraryTemplateCustomResource)
        protected assetLibraryTemplateCustomResource: AssetLibraryTemplateCustomResource,
        @inject(TYPES.CommandsTemplateCustomResource)
        protected commandsTemplateCustomResource: CommandsTemplateCustomResource,
        @inject(TYPES.CommandsCommandCustomResource)
        protected commandsCommandCustomResource: CommandsCommandCustomResource,
        @inject(TYPES.IotEndpointCustomResource)
        protected iotEndpointCustomResource: IotEndpointCustomResource,
        @inject(TYPES.IotEventsCustomResource)
        protected iotEventsCustomResource: IotEventsCustomResource,
        @inject(TYPES.IotFleetIndexCustomResource)
        protected iotFleetIndexCustomResource: IotFleetIndexCustomResource,
        @inject(TYPES.IotPoliciesCustomResource)
        protected iotPoliciesCustomResource: IotPoliciesCustomResource,
        @inject(TYPES.IotRoleAliasCustomResource)
        protected iotRoleAliasCustomResource: IotRoleAliasCustomResource,
        @inject(TYPES.IotThingGroupCustomResource)
        protected iotThingGroupCustomResource: IotThingGroupCustomResource,
        @inject(TYPES.IotThingTypeCustomResource)
        protected iotThingTypeCustomResource: IotThingTypeCustomResource,
        @inject(TYPES.RotateCertificatesJobCustomResource)
        protected rotateCertificatesJobCustomResource: RotateCertificatesJobCustomResource,
        @inject(TYPES.NeptuneEngineCustomResource)
        protected neptuneEngineCustomResource: NeptuneEngineVersionCustomResource,
        @inject(TYPES.VpcEndpointCheckCustomResource)
        protected vpcEndpointCheckCustomResource: VpcEndpointCheckCustomResource,
        @inject(TYPES.VpcEndpointCustomResource)
        protected vpcEndpointCustomResource: VpcEndpointCustomResource,
        @inject(TYPES.S3PutObjectCustomResource)
        protected s3PutObjectCustomResource: S3PutObjectCustomResource,
        @inject(TYPES.IotDeviceDefenderCustomResource)
        protected iotDeviceDefenderCustomResource: IotDeviceDefenderCustomResource,
        @inject(TYPES.EventSourceCustomResource)
        ...
        this.customResources['Custom::ApplicationConfigOverride'] =
        ...
        this.customResources['Custom::AssetLibraryBulkGroups'] =
        ...
        this.customResources['Custom::RotateCertificatesJob'] =
