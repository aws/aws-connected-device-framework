...
DESCRIPTION
    Packages the CDF Simulator, ready for deployment.
...
logTitle 'Packaging the Simulation Launcher CloudFormation template and uploading to S3'

aws cloudformation package \
  --template-file $cwd/cfn-simulation-launcher.yaml \
  --output-template-file $cwd/build/cfn-simulation-launcher-output.yaml \
  --s3-bucket $DEPLOY_ARTIFACTS_STORE_BUCKET \
  --s3-prefix packaged-cfn-artifacts \
  $AWS_ARGS

logTitle 'Simulation Launcher packaging complete!'
