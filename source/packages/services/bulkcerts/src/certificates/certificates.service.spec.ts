...
describe('CertificatesService', () => {
    ...
    beforeEach(() => {
        ...
        instance = new CertificatesService(
    ...
    it('createBatch should create batch with customer CA', async () => {
        ...
        mockUploadResponse.response = {
            ETag: 'test',
            Location: 'https://unit-test-bucket.s3.amazon.com/certs/testBatchId',
            Bucket: 'unit-test-bucket',
            Key: 'certs/testBatchId',
        };
        ...
        const mockDescribeCaCert = (mockIot.describeCACertificate = <any>(
            jest.fn((_params) => mockDescribeCaCertResponse)
        ));
        ...
        const mockGetParameter = (mockSsm.getParameter = <any>(
            jest.fn((_params) => mockGetParameterResponse)
        ));
        ...
        expect(mockDescribeCaCert).toBeCalledWith({
            certificateId: '3d2ecfdb0eba2898626291e7e18a37cee791dbc81940a39e8ce922f9ff2feb32',
        });
        expect(mockGetParameter).toBeCalledWith({
            Name: `cdf-ca-key-3d2ecfdb0eba2898626291e7e18a37cee791dbc81940a39e8ce922f9ff2feb32`,
            WithDecryption: true,
        });
    });
    ...
    it('createBatch should create batch with AWS IoT CA', async () => {
        ...
        const mockCreateCertFromCsr = (mockIot.createCertificateFromCsr = <any>(
            jest.fn((_params) => mockCreateCertFromCsrResponse)
        ));
    ...
    it('createBatch should create batch with AWS ACMPCA', async () => {
        ...
        const mockIssueCertificate = (mockApmca.issueCertificate = <any>(
            jest.fn((_params) => mockIssueCertificateResponse)
        ));
        ...
        const mockGetCertificate = (mockApmca.getCertificate = <any>(
            jest.fn((_params) => mockGetCertificateResponse)
        ));
    ...
    it('deleteBatch should delete batch for valid id', async () => {
        ...
        const mockListObjectsV2 = (mockS3.listObjectsV2 = <any>(
            jest.fn((_params) => mockListObjectsV2Response)
        ));

        // then delete issue a request to delete the objects
        const deleteObjectsData = {
            Deleted: [{ Key: 'testBatchId/certs.zip' }],
            Errors: [] as any,
        };
        ...
        const mockDeleteObjects = (mockS3.deleteObjects = <any>(
            jest.fn((_params) => mockDeleteObjectsResponse)
        ));
        ...
        expect(mockListObjectsV2).toBeCalledWith({
            Bucket: 'unit-test-bucket',
            Prefix: 'certs/testBatchId',
        });
        expect(mockDeleteObjects).toBeCalledWith({
            Bucket: 'unit-test-bucket',
            Delete: { Objects: [{ Key: 'testBatchId/certs.zip' }] },
        });
    });
