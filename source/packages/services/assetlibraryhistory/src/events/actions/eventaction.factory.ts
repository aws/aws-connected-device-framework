...
export class EventActionFactory {
    constructor(
        ...
        @inject(TYPES.UpdateComponentParentEventAction)
        private updateComponentParentAction: UpdateComponentParentAction,
    ...
    private isComponentEvent(event: EventModel): boolean {
        const isEvent =
            event.attributes !== undefined && event.attributes['componentId'] !== undefined;
