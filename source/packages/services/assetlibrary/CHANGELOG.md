# Change Log - @awssolutions/cdf-assetlibrary
...
- properly handle undefined string for count and offset
- properly quote escaped regex pattern in cloudformation
...
- Change connection life cycle between Lambda and Neptune
...
- Neptune deployment group version upgraded to 1.2.
