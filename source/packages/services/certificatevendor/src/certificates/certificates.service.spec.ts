...
describe('CertificatesService', () => {
    ...
    it('requesting certificate returns success', async () => {
        ...
        const mockUpdateCert = (mockedIot.updateCertificate = jest
            .fn()
    ...
    it('requesting certificate with CSR returns success', async () => {
        ...
        const mockedDescribeCaCertificate = (mockedIot.describeCACertificate = jest
            .fn()
            .mockImplementationOnce(() => {
                return {
                    promise: () => caCert,
        ...
        const mockedGetParameter = (mockedSSM.getParameter = jest
            .fn()
            .mockImplementationOnce(() => {
                return {
                    promise: () => ssmParam,
        ...
        const registerCert = {
            certificateArn:
                'arn:aws:iot:us-west-2:xxxxxxxxxx:cert/aa889ee7a74458d6ef4595c50be546982c6cf30d29c32481556639723cf550ce',
        ...
        const mockedRegisterCert = (mockedIot.registerCertificate = jest
            .fn()
        ...
        const mockedAttachThingPrincipal = (mockedIot.attachThingPrincipal = jest
            .fn()
            .mockImplementationOnce(() => {
                return {
        ...
        const attachPolicy = {};
        const mockedAttachPolicy = (mockedIot.attachPolicy = jest
            .fn()
            .mockImplementationOnce(() => {
                return {
        ...
        expect(mockedAttachThingPrincipal).toBeCalledWith({
            principal:
                'arn:aws:iot:us-west-2:xxxxxxxxxx:cert/aa889ee7a74458d6ef4595c50be546982c6cf30d29c32481556639723cf550ce',
            thingName: deviceId,
        });
        expect(mockedAttachPolicy).toBeCalledWith({
            target: 'arn:aws:iot:us-west-2:xxxxxxxxxx:cert/aa889ee7a74458d6ef4595c50be546982c6cf30d29c32481556639723cf550ce',
            policyName: rotateCertPolicy,
        });
    ...
    it('requesting certificate with CSR with inherited policies returns success', async () => {
        ...
        const previousCertificateId =
            'aa889ee7a74458d6ef4595c50be546982c6cf30d29c32481556639723cf550ce';
        const EffectivePolicies = {
            effectivePolicies: [{ policyName: 'unitTestPolicy1' }],
        };
        const mockedgetEffectivePolicies = (mockedIot.getEffectivePolicies = jest
            .fn()
            .mockImplementationOnce(() => {
                return {
        ...
        expect(mockedgetEffectivePolicies).toBeCalledWith({
            principal:
                'arn:aws:iot:us-west-2:12345678:cert/aa889ee7a74458d6ef4595c50be546982c6cf30d29c32481556639723cf550ce',
        });
    ...
    it('acknowledging certificate rotation returns success', async () => {
        ...
        const mockRemoveThingFromThingGroup = (mockedIot.removeThingFromThingGroup = jest
            .fn()
            .mockImplementationOnce(() => {
                return {
