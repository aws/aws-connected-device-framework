...
container
    .bind<string>('acmpca.caArn')
    .toConstantValue(process.env.ACMPCA_CA_ARN);
container
    .bind<boolean>('acmpca.enabled')
    .toConstantValue(process.env.ACMPCA_ENABLED === 'true');
container
    .bind<string>('acmpca.singnalingAlgorithm')
    .toConstantValue(process.env.ACMPCA_SIGNALING_ALGORITHM);
