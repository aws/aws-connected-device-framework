...
container.bind<string>('aws.s3.certificates.presignedUrlExpiresInSeconds').toConstantValue(process.env.AWS_S3_CERTIFICATES_PRESIGNEDURL_EXPIRESINSECONDS);
container.bind<string>('mqtt.topics.get.success').toConstantValue(process.env.MQTT_TOPICS_GET_SUCCESS);
container.bind<string>('mqtt.topics.get.failure').toConstantValue(process.env.MQTT_TOPICS_GET_FAILURE);
container.bind<string>('mqtt.topics.ack.success').toConstantValue(process.env.MQTT_TOPICS_ACK_SUCCESS);
