...
export class CoresDao {
        ...
        cores.forEach((c) => {
            ...
            items.TransactItems.push({
                Update: {
                    ...
                    UpdateExpression:
                        'SET #deploymentStatus=:deploymentStatus, #deploymentStatusMessage=:deploymentStatusMessage, #siKey4=:siKey4, #siKey5=:siKey5, #siKey6=:siKey6',
                    ExpressionAttributeNames: {
                    ...
                    ExpressionAttributeValues: {
                        ...
                        ':siKey5': createDelimitedAttribute(
                            PkType.DeploymentStatus,
                            'FAILED',
                            PkType.Template,
                            c.templateName
    ...
    public async list(
        ...
        if (failedOnly) {
            params = this.generateListFilteredByFailedDeployments(
                templateName,
                templateVersion,
                count,
                exclusiveStart
    ...
    private generateListFilteredByTemplateVersionQuery(
        templateName: string,
        templateVersion: number,
        count?: number,
        exclusiveStart?: CoreListPaginationKey
    ...
    private generateListFilteredByFailedDeployments(
        ...
        if (templateName === undefined) {
            ...
            siKeyDbId = createDelimitedAttribute(
                PkType.DeploymentStatus,
                'FAILED',
                PkType.Template,
                templateName
