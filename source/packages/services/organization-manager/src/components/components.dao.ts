...
export class ComponentsDao {
    ...
    public async createComponent(item: ComponentItem): Promise<void> {
        ...
        const { parameters, description, runOrder, organizationalUnitId, name, resourceFile, bypassCheck } = item;
        await this._dc.put({
    ...
    private static assembleComponents(result: AWS.DynamoDB.DocumentClient.ItemList): ComponentItem[] {
    ...
    private static assembleComponent(result: AWS.DynamoDB.DocumentClient.AttributeMap): ComponentItem {
    ...
    public async deleteComponentByOu(organizationalUnitId: string, componentName: string): Promise<void> {
        logger.debug(`components.dao deleteComponent: in: organizationalUnitId:${organizationalUnitId} componentName:${componentName}`)
    ...
    public async deleteComponentsByOu(organizationalUnitId: string): Promise<void> {
        logger.debug(`components.dao deleteComponents: in: organizationalUnitId:${organizationalUnitId}`)
