        ...
        const expected:DeviceAssociationModel = {
            ...
            things: {
                core: {
                    ...
                    thingId: 'core-id-1',
                    thingArn: `arn:aws:iot:us-west-0:xxxxxxxxxxxx:thing/${input.taskInfo.devices[0].thingName}`,
                },
                'device-1': {
                    thingName: input.taskInfo.devices[1].thingName,
                    thingId: 'device-id-1',
                    thingArn: `arn:aws:iot:us-west-0:xxxxxxxxxxxx:thing/${input.taskInfo.devices[1].thingName}`,
                }
            },
        };
