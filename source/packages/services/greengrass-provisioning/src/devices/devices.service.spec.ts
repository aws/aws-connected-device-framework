...
describe('DevicesService', () => {
    ...
    it('associateDevicesWithGroup: happy path', async() => {
        ...
        expect(mockedGreengrassUtils.getCoreInfo.mock.calls[0][0]).toEqual('arn:aws:greengrass:us-west-0:xxxxxxxxxxxx:/greengrass/definition/cores/core-def-1/versions/core-def-version-1');
        expect(mockedGreengrassUtils.getDeviceInfo.mock.calls[0][0]).toEqual('arn:aws:greengrass:us-west-0:xxxxxxxxxxxx:/greengrass/definition/devices/device-def-1/versions/device-def-version-1');
