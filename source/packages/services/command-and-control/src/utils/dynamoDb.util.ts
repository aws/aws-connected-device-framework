...
export class DynamoDbUtils {
    ...
    public putAttributeIfDefined(itemMap:AWS.DynamoDB.DocumentClient.PutItemInputAttributeMap | AWS.DynamoDB.DocumentClient.PutItemInputAttributeMap, key:string, value:unknown) : void {
        if (value!==undefined) {
            itemMap[key] = value;
        }
    }
