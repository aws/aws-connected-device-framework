...
| `OpenSSL Lambda Layer`                     | [cfn-openssl-layer.template](../../../infrastructure/cloudformation/cfn-openssl-layer.yaml)                                                                       | None                                                                                            | None                               |                                                                                                                                       |
...
| `Asset Library History`                    | [cfn-assetLibraryHistory.template](../assetlibrary-history/infrastructure/../../assetlibraryhistory/infrastructure/cfn-assetLibraryHistory.yml)                   | `KMS`<br>`Asset Library Service`                                                                | `VPC`                              | `VPC` is only needed when you need to run API Gateway in **private** mode                                                             |
