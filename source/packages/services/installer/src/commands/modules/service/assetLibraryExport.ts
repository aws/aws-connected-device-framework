...
export class AssetLibraryExportInstaller implements ServiceModule {
    ...
    public readonly dependsOnMandatory: ModuleName[] = ['assetLibrary', 'kms'];
            ...
            [
                ...
                ...applicationConfigurationPrompt(this.name, answers, [
                    ...
                    },
                    {
                        ...
                        question:
                            'Specify any specific attributes which needs to be extracted, if its set to empty string then all attributes are extracted',
                    ...
                    },
                    {
                        ...
                        question:
                            'Specify this property to export the data batched by types, the supported config is either "type" or "category"',
                    ...
                    },
                    {
                        ...
                        defaultConfiguration:
                            "${aws.s3.export.prefix}${batch.category}/${batch.type}/dt=${moment(batch.timestamp).format('YYYY-MM-DD-HH-MM')}/${batch.id}.json",
                    },
                ]),
            ],
            updatedAnswers,
