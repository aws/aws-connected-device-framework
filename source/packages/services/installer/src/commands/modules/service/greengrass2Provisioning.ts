...
export class Greengrass2ProvisioningInstaller implements RestModule {
    ...
    constructor(environment: string) {
        ...
        this.defaultInstallerConfigGenerators = {
            MANUAL_INSTALL: manualInstallConfigGenerator,
            FLEET_PROVISIONING: fleetProvisioningConfigGenerator,
        };
    }
    ...
    private getParameterOverrides(answers: Answers): string[] {
        const parameterOverrides = [
            ...
            `AssetLibraryFunctionName=${
                answers.greengrass2Provisioning.assetLibraryFunctionName ?? ''
            }`,
