...
DESCRIPTION
    Packages the CDF Simulation Manager service, ready for deployment.
...
logTitle 'Packaging the Simulation Manager CloudFormation template and uploading to S3'

aws cloudformation package \
  --template-file $cwd/cfn-simulation-manager.yml \
  --output-template-file $cwd/build/cfn-simulation-manager-output.yml \
  --s3-bucket $DEPLOY_ARTIFACTS_STORE_BUCKET \
  --s3-prefix packaged-cfn-artifacts \
  $AWS_ARGS

logTitle 'Simulation Manager packaging complete!'
