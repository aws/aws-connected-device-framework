...
DESCRIPTION
    Packages the CDF Asset Library Export Service.
...
logTitle 'Packaging the Asset Library Export CloudFormation template and uploading to S3'
aws cloudformation package \
  --template-file $cwd/cfn-assetlibrary-export.yaml \
  --output-template-file $cwd/build/cfn-assetlibrary-export-output.yaml \
  --s3-bucket $DEPLOY_ARTIFACTS_STORE_BUCKET \
  --s3-prefix packaged-cfn-artifacts \
  $AWS_ARGS

logTitle 'Asset Library Export packaging complete!'
