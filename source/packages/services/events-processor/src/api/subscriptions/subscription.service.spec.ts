...
describe('SubscriptionService', () => {
    ...
    it('get happy path', async () => {
        ...
        const mockedTargetDelete = (mockedTargetService.delete = jest
            .fn()
            .mockReturnValue(undefined));
        const mockedTargetUpdate = (mockedTargetService.update = jest
            .fn()
            .mockReturnValue(undefined));
    ...
    it('get with PendingConfirmation still pending', async () => {
        ...
        const mockedSnsList = (mockedSNSTarget.listSubscriptions = jest
            .fn()
            .mockReturnValueOnce(snsListResponse));
        const mockedTargetUpdate = (mockedTargetService.update = jest
            .fn()
            .mockReturnValue(undefined));
    ...
    it('get with PendingConfirmation is confirmed', async () => {
        ...
        expected.targets.email[0].subscriptionArn = 'sub-arn-1';
    ...
    it('list target arns happy path', async () => {
        ...
        // stubs
        const stubbedSubscriptionItems = [
            stubSubscriptionItem1(),
            stubSubscriptionItem2(),
            stubSubscriptionItem3(),
        ];
