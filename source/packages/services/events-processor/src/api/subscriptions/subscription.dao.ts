...
export class SubscriptionDao {
    ...
    public async update(si: SubscriptionItem): Promise<void> {
        ...
        if (si.enabled !== undefined) {
            params.UpdateExpression = !params.UpdateExpression ? 'set enabled=:re' : `${params.UpdateExpression}, enabled=:re`
    ...
    public async listSubscriptionsForEventMessage(eventSourceId: string, principal: string, principalValue: string): Promise<SubscriptionItem[]> {
        ...
        const params: DocumentClient.QueryInput = {
            ...
            ProjectionExpression: 'address,attributeMapping,conditions,disableAlertThreshold,enabled,eventSourceId,#name,phoneNumber,pk,platformApplicationArn,platformEndpointArn,principal,principalValue,ruleParameterValues,sk,snsTopicArn,subscriptionArn,subscriptionId,tableName,targetType,#token,topic'
        };
